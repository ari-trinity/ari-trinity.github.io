...
const personalizedCompliments = {
  ...
  judy: [
    "Judy didn't just raise the bar - she built the whole building, owns it, and still found time to cook everyone dinner.",
    "If patience were a superpower, Judy would be the one training all the other superheroes.",
    "Judy walks into a room and the whole energy shifts - that's not an entrance, that's a blessing.",
    "God took His time making Judy. This was not a rush job.",
    "Some people bring peace to a room. Judy is the peace.",
    "Judy doesn't just have a seat at the table - she owns multiple tables. And the chairs. And the building.",
    "MBA programs should just assign a case study called 'What Would Judy Do?'",
    "She runs companies the same way she does everything else - with grace, intelligence, and zero drama.",
    "CEOs study Judy. Quietly. From a distance.",
    "Judy's love language is cooking a full meal, wrapping a gift, and then asking if you need seconds - all at the same time.",
    "If you've ever received a gift from Judy, you already know - she doesn't just give gifts, she gives experiences.",
    "Judy loves her Stephens so deeply it could fill a novel. A long one. A beautiful one.",
    "Her son Stephen is loved. Her husband Stephen is loved. Anyone named Stephen near Judy is statistically having a great day.",
  ],
  stephen: [
